...
public class AnimatedNameApplet extends JPanel {
    ...
    private String name = "Rashi Namdev"; // Replace with your name
    private int fontSize = 50; // Initial font size
    private int direction = 2; // Direction of font size change: 1 for increasing, -1 for decreasing
